...
HD_PWD='C:/Users/Tore/Desktop/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log font_test_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source font_test_top.tcl -notrace
